...
circuit_obj.add_vsource_element(name="Vsource", bus1_name="A", v=100.0)
circuit_obj.add_resistor_element(name="Rab", bus1_name="A", bus2_name="B", r=5.0)
circuit_obj.add_load_element(name="Lb", bus1_name="B", p=2000.0, q=0.0)
